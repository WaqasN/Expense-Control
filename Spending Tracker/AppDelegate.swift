...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func setupDefaultAppearance() {
        ...
        navigationBarAppearance.barTintColor = UIColor.themeTint
        navigationBarAppearance.tintColor = UIColor.white
        navigationBarAppearance.titleTextAttributes = [
            NSAttributedString.Key.font: UIFont.boldSystemFont(ofSize: 18),
            NSAttributedString.Key.foregroundColor : UIColor.themeWhite
        ]
        ...
        toolBarAppearance.barTintColor = UIColor.themeTint
        ...
        tabBarAppearance.tintColor = UIColor.themeTint
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Spending_Tracker")
